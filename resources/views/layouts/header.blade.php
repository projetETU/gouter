    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav">
                ...
                <li class="nav-item ">
                    <a class="nav-link {{ Request::path() == 'ingredientForm' ? 'active' : '' }}" href="ingredientForm">New Ingredient</a>
                </li>
                <li class="nav-item ">
                    <a class="nav-link {{ Request::path() == 'categorieForm' ? 'active' : '' }}" href="categorieForm">New Categories</a>
                </li>
                <li class="nav-item ">
